...
class TestQueryParamsToMovieFilter(TestCase):
    def test_empty_query_params(self) -> None:
        query_params = QueryDict()
        result: MovieFilter = query_params_to_movie_filter(query_params)
    ...
    def test_rating_range_mapping(self) -> None:
